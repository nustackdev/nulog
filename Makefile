...
help:
	@echo "$(BLUE)Nulog - Development Commands$(NC)"
	@echo ""
	@echo "$(GREEN)Setup:$(NC)"
...
test-cov:
	...
	pytest $(TEST_DIR) --cov=nulog --cov-report=html:tests/reports/coverage --cov-report=term-missing --cov-branch
...
lint:
	...
	ruff check $(SRC_DIR)/nulog $(TEST_DIR)

format:
	@echo "$(BLUE)Formatting code...$(NC)"
	ruff format $(SRC_DIR)/nulog $(TEST_DIR)
	ruff check --fix $(SRC_DIR)/nulog $(TEST_DIR)
	@echo "$(GREEN)Code formatted$(NC)"

format-check:
	@echo "$(BLUE)Checking code format...$(NC)"
	ruff format --check $(SRC_DIR)/nulog $(TEST_DIR)
	ruff check $(SRC_DIR)/nulog $(TEST_DIR)
...
publish-test: check-dist
	...
	@echo "  pip install --index-url https://test.pypi.org/simple/ nulog"
...
publish: check-dist
	...
	@echo ""
	@echo "Install with: pip install nulog"
